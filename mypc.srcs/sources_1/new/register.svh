...
parameter machine_p::func_t GPIO0_ADDR         = 6'h2d;  // GPIO0〜GPIO7(GPIO0〜5はPmod Aと物理ピンを共有するため未結線)
parameter machine_p::func_t GPIO1_ADDR         = 6'h2e;  // GPIO8〜GPIO15
parameter machine_p::func_t GPIO2_ADDR         = 6'h2f;  // GPIO16〜GPIO23
parameter machine_p::func_t GPIO3_ADDR         = 6'h30;  // GPIO24〜GPIO27(GPIO25〜27は対応する物理ピンが無いため未結線)
